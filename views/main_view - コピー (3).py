...
class MainView:
    ...
    def _render_header(self):
        ...
        # Independent Clock Component (Iframe via st.components.v1)
        # Refined styles: Helvetica, Bold (900), adjusted spacing
        clock_html = """
        <!DOCTYPE html>
        <html>
        <head>
        ...
        """
        # Height adjustment for the component iframe
    ...
    def _render_morning_mode(self):
        ...
        if not items:
            ...
            # Ensure footer is shown even if no items
            self._render_footer()
        ...
        for i, item in enumerate(items):
            ...
            with cols[i % 2]:
                # Marker for CSS targeting (The "GuraGura" style)
    ...
    def _inject_custom_css(self):
        ...
        b64_on = get_img_base64("image/check_on.png")
        b64_off = get_img_base64("image/check_off.png")
        ...
        /* 
           ...
           The marker is inside a Markdown Container. The Button is inside a Button Container.
           These containers are siblings.
           We target the Container that HAS the marker, then find its next sibling Container, then the button inside.
        */
        div:has(.item-btn-marker) + div button {{
            padding-left: 70px !important; /* Space for icon */
            position: relative;
            display: flex;
            align-items: center;
        ...
        /* Icon Element (::before) applied to the TARGETED buttons */
        ...
        /* GO Button fallback styling if needed */
